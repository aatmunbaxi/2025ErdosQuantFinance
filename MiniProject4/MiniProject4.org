...
#+RESULTS:
[[file:./.ob-jupyter/a3eeda8de761557826227e27538526828290e6bf.png]]
...
The discretized CEV dynamics can obey
...
The CEV model's drift term depended on both \(t\) and \(S_t\).
