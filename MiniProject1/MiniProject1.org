...
[[file:./.ob-jupyter/91667761bbcc5567f89e27b09a75d5aff804c801.png]]
:END:
...
Those invested in bonds in the 80s likely have recurring ulcer issues.
...
#+RESULTS:
:RESULTS:
: array([<Axes: xlabel='Monthly Return (%)', ylabel='Frequency'>,
:        <Axes: xlabel='Monthly Return (%)', ylabel='Frequency'>],
:       dtype=object)
[[file:./.ob-jupyter/4a9ceec9ce75074a3f50fdea8e7f11adcbdc8f4f.png]]
:END:

Both distributions visually appear to exhibit negative skewness, in line with the high concentration of equities and the risk of sudden, rapid unrealized losses that they carry.
#+begin_src jupyter-python :exports both :session MiniProject1
both.skew(axis=0)
#+end_src

#+RESULTS:
: Portfolio 1 Returns   -0.240736
: Portfolio 2 Returns   -0.342016
: dtype: float64
...
[[file:./.ob-jupyter/5ca5ad24ba34fc28a6cd58feccbbbbe2f70f1bc7.png]]
:END:
